...
function CabinCategoryRow({ category }) {
  ...
  return (
    <div className="grid grid-cols-[1fr_1fr_1fr_2fr_auto_auto] gap-x-4 items-center text-sm ml-4 py-0.5 border-b border-gray-200">
      ...
      <span className="text-gray-700 truncate">{cabinNumbers}</span>
      <span className="text-gray-700">
        {fullPrice} <span className="text-xs text-gray-400">({discountPrice})</span>
      </span>
      <span className="px-2 py-0.5 rounded-full bg-blue-100 text-blue-700 text-xs text-center w-fit">
